...
<title>Product/Services-Solo Music Center</title>
	...
	<link rel="stylesheet" type="text/css" href="styles/user.css?v=<?php echo time(); ?>">
...
<body>
  ...
  <div>
    <!--Button to connect View user account details Page-->
  
    <button class="bttn3" type="button" id="btn3" onclick=""><a href="displaydetails.php"><i style="font-size:24px" class="fa">&#xf2be;</i> VIEW USER ACCOUNT DETAILS</a></button>
